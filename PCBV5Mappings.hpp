...
#define HEATER_VOLTAGE_EQ(v) (((int32_t)(v)*1035)/310)
...
#define CATHODE_OFFSET_VOLTAGE_EQ(v) (((int32_t)(v)*-86463)/1000)+301437//((v)*-85.75+400430) //NOTE: Protection zener diode makes conversions non-linear at the high end.
																//This is not accounted for here. Check ADC Signal processing document for details

#define HEATER_CURRENT_EQ(v) ((int32_t)(v)*2*957/1000-66)
#define TETHER_BIAS_CURRENT_EQ(v) ((((int32_t)(v) - 1020) * 1015) / 19608)
#define CATHODE_OFFSET_CURRENT_EQ(v) (((int32_t)(v) - 2483) * 780 / 500)
...
#define HEATER_MIN_VOLTAGE_MILLIVOLTS 1400

#define CATHODE_OFFSET_MAX_VOLTAGE_MILLIVOLTS 255000
#define CATHODE_OFFSET_MIN_VOLTAGE_MILLIVOLTS 0

#define TETHER_BIAS_MAX_VOLTAGE_MILLIVOLTS 255000
#define TETHER_BIAS_MIN_VOLTAGE_MILLIVOLTS 0
...
#define CATHODE_OFFSET_TARGET_VOLTAGE_TO_DAC_VOLTAGE(v) (((v)*100)/5138)
